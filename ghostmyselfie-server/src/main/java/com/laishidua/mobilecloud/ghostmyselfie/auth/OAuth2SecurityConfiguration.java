package com.laishidua.mobilecloud.ghostmyselfie.auth;
...
import com.laishidua.mobilecloud.ghostmyselfie.utils.LoadUserDetailsService;

/**
 *	Configure this web application to use OAuth 2.0.
 *
 * 	The resource server is located at "/ghostmyselfie", and can be accessed only by retrieving a token from "/oauth/token"
...
public class OAuth2SecurityConfiguration {
	...
	protected static class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
		...
		@Autowired
		private LoadUserDetailsService userDetailsService;
	 ...
	 *	resource server (i.e. the "/ghostmyselfie" endpoint) 
	 */
	@Configuration
	...
	protected static class ResourceServer extends
		...
		// all of the paths in the ghostmyselfie service.
		@Override
	...
	protected static class OAuth2Config extends
		 ...
		 * passwords listed below and updating the GhostMySelfieSvcClientApiTest.
		 * 
		 * @param auth
		 * @throws Exception
		 */
