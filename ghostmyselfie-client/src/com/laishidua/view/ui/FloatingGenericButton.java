 ...
 */
public class FloatingGenericButton extends View {
    /**
     ...
     * @param attrs
     */
	public FloatingGenericButton(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    /**
     * Sets the Color of FloatingTakeSelfieButton.
     * 
    ...
    /**
     * Sets the Icon of FloatingTakeSelfieButton.
     * 
